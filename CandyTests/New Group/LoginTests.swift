...
class LoginTests: XCTestCase {
    ...
    func testInvalidUsernameLength(){
        ...
        sut.loginService = LoginServiceDelegate(delegate: actionDelegate, loginType: .LOGIN)
    ...
    func testSuccessfullValidation(){
        let actionDelegate = FakeLoginActionService()
        let loginService = LoginServiceDelegate(delegate: actionDelegate, loginType: .LOGIN)
    ...
    func testIfUsernameAndPasswordIsNotValidFromRealm(){
        let actionDelegate = FakeLoginActionService()
        
        let loginService = LoginServiceDelegate(delegate: actionDelegate, loginType: .LOGIN)
        loginService.loginWith(username: "olayinka", password: "Lawal3")
